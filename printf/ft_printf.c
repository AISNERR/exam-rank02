...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/03/26 16:09:32 by aisner            #+#    #+#             */
/*   Updated: 2022/03/26 16:09:33 by aisner           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_list init_struct(t_list flags) //doen
{
	flags.width = 0;
	flags.point = 0;
	flags.precis = 0;
...
int is_spec(char c) // done
{
	return (c == 's' || c == 'd' || c == 'x');
}

t_list pars_flags(t_list flags, char *str) ///DONE
{
	int i = 0;
